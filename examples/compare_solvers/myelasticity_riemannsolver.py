...
def nonlinear_elasticity_1D(q_l, q_r, aux_l, aux_r, problem_data):
    ...
    *aux* is expected to contain -
     ...
     - aux[2,i] - K2 (cubic nonlinear stress relation)
